...
<p style="color: red; font-weight: bold;">Rendr is in active development and is currently very unstable.</p>
...
## Run for yourself
1. Clone the code. `git clone https://github.com/tgranz/rendr.git`
2. Set up Node + dependencies. `npm install`
3. Run `npm run dev` and open a browser to http://localhost:5173 to view.
